...
```{r}
generation <- read_csv(here("wk-06/data/what_a_waste/what-a-waste-city-level-data-generation.csv"))

population <- read_csv(here("wk-06/data/what_a_waste/what-a-waste-city-level-data-population.csv"))

country_income <- read_csv(here("wk-06/data/what_a_waste/what-a-waste-city-level-data-country-income.csv"))
```
...
generation_country_income <- read_rds(here("wk-06/data/what_a_waste/what-a-waste-city-level-data-country-income.rds"))
...
5.  Go to your wk-06-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.
