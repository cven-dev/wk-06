...
```{r}
city_data <- read_csv(here("wk-06/data/what_a_waste/what-a-waste-city-level-data.csv"))
distance <- read_csv(here("wk-06/data/what_a_waste/what-a-waste-city-level-data-distance.csv"))
```
